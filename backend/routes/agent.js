...
const getAllProjects = async () => {
  return queryAll(`
    SELECT
      ...
      usecase_identifier, icon, useful_links, strategic_focus, ranking
    FROM apps
      ...
      try {
        await query(`
          INSERT INTO use_case_intake (
            ...
            compliance_gate, knockout_count, solution_approach, recommended_action, status
          ) VALUES (
...
**Before starting intake**: Check for similar existing projects using show_projects with filter_type "search".
